...
class CarSimulator:
    ...
    def __init__(self, graphml_path=None, v_max_kmh=50, v_min_kmh=10,
        ...
        if graphml_path is None:
            ...
            graphml_path= Path(__file__).resolve().parent.parent / "data" / "osm" / "bordeaux_network.graphml"
    ...
    def reset(self, seed=None):
        ...
        for attempt in range(MAX_RETRIES):
            self.current_hour = self.rng.uniform(0.0, 23.59)
            ...
            for candidate_node in start_nearby:
                ...
                self.remaining_distance_km = dist_to_station
                ...
                self.time_to_station = 60 * dist_to_station / max(speed_at_start, 1e-6)
                return
